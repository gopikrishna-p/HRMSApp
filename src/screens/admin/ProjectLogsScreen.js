...
const LogCard = ({ log, onStop }) => {
    ...
    return (
        <View style={styles.logCard}>
            <View style={styles.logHeader}>
                ...
                <View style={{ flex: 1 }}>
                    <View style={styles.logTitleRow}>
                        <Text style={styles.logTitle} numberOfLines={1}>{log.description || 'Work Log'}</Text>
            ...
            {/* Added info from your List.Item snippet without changing UI framework */}
            <View style={[styles.logDetails, { marginTop: 3 }]}>

                {/* Description block lines: Time / Task / By */}
                <View style={styles.logDetailRow}>
                    <Icon name="history" size={12} color="#6B7280" />
                    <Text style={styles.logDetailText}>Time: {String(log.log_time)}</Text>
                </View>

                {log.task ? (
                    <View style={styles.logDetailRow}>
                        <Icon name="tasks" size={12} color="#6B7280" />
                        <Text style={styles.logDetailText}>Task: {log.task}</Text>
                    </View>
                ) : null}
                ...
                {log.employee ? (
                    <View style={styles.logDetailRow}>
                        ...
                        <Text style={styles.logDetailText}>By: {log.employee}</Text>
                    </View>
                ) : null}
            </View>
            {/* End added block */}
