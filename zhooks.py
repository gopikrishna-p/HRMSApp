...
permission_query_conditions = {
	"Project": "hrms.api.project_setup.project_query",
    "Task": "hrms.api.project_setup.task_query",
    "Task Log": "hrms.api.project_setup.task_log_query",
}
#
# has_permission = {
...
# }
has_permission = {
	"Project": "hrms.api.project_setup.project_has_permission",
    "Task": "hrms.api.project_setup.task_has_permission",
    "Task Log": "hrms.api.project_setup.task_log_has_permission",
}
...
doc_events = {
	...
	"Daily Task Log": {
        "before_save": "hrms.api.validate_daily_task_log"
    },
	"Salary Slip": {
    	"before_validate": "hrms.api.set_wfh_days"
    },
	"Task": {
		"on_update": "hrms.controllers.employee_boarding_controller.update_task",
        "before_insert": "hrms.api.project_setup.task_before_insert",
        "validate": "hrms.api.project_setup.task_validate",
    },
	"Task Log": {
        "before_validate": "hrms.api.project_setup.task_log_before_validate",
        "validate": "hrms.api.project_setup.task_log_validate",
    },
